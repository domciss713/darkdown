...
export async function LayoutShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen dd-gradient-bg flex flex-col">
      <SessionKeepalive />
      <header className="relative z-[120] px-3 pt-3">
        <div className="mx-auto flex max-w-6xl items-center justify-between rounded-2xl px-4 py-3 dd-liquid-bar">
          ...
          <details className="relative z-[130] md:hidden">
            ...
            <div className="absolute right-0 top-11 z-[140] w-52 rounded-xl border border-white/20 bg-[#120d22f2] p-2 shadow-2xl backdrop-blur-xl">
